...
void JsonShot::init(GameWrapper* gw, Console* cons)
{
...
void JsonShot::setVelocity(GameWrapper* gw, Console * cons, Vector ballLoc) {
...
void JsonShot::set(GameWrapper* gw, Console * cons)
{
