...
public:
	...
	~JsonShot();
	void init(GameWrapper* gw, ConsoleWrapper* cons);
	void setVelocity(GameWrapper * gw, ConsoleWrapper * cons, Vector ballLoc);
	void set(GameWrapper* gw, ConsoleWrapper* cons);
	json_shot getShot();
};
